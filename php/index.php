...
<div id="wrapper">
	<div id="ring1">
    	<div id="ring2">
        	<div id="ring3">
            	<div id="menu">
                	<a href="index_files.php"><img src="img/musikPlayer.png"></a>
                    <a href="index_ukw.php"><img src="img/ukw.png"></a>
                    <a href="einstellungen.php"><img src="img/einstellungen.png"></a>
                </div>
